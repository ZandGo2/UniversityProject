...
function Header() {
  ...
  useEffect(() => {
    if (pathname === "/") document.title = "تورینو | تورگردی متمایز";
  ...
  return (
    <header
      className={`${styles.header} ${isSticky ? styles.sticky : styles.static}`}
    >
      <div className={styles.container}>
          ...
          <nav>
            <ul>
              ...
              <li>
                <Link
                  href="/services"
                  className={pathname === "/services" ? styles.active : null}
                >
                  خدمات گردشگری
                </Link>
              </li>
              <li>
                <Link
                  href="/about-us"
                  className={pathname === "/about-us" ? styles.active : null}
                >
                  درباره ما
                </Link>
              </li>
              <li>
                <Link
                  href="/contact-us"
                  className={pathname === "/contact-us" ? styles.active : null}
                >
                  تماس باما
                </Link>
              </li>
        ...
        {isLogin ? (
          ...
          <>
            ...
            <span className={styles.mobileLogin} onClick={loginHandler}>
              <Login />
            </span>
          </>
        )}
