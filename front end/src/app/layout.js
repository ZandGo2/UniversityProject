...
export const metadata = {
  ...
  description:
    "تورینو ارائه‌دهنده خدمات رزرو تورهای مسافرتی داخلی و خارجی به‌صورت آنلاین، با پشتیبانی ۲۴ ساعته و پیشنهادهای ویژه سفر.",
  keywords:
    "رزرو تور آنلاین، خرید اینترنتی تور، تورهای داخلی و خارجی، سفرهای تفریحی، بهترین تورهای گردشگری، رزرو هتل و اقامتگاه، برنامه سفر، گردشگری بین‌المللی، تور یک روزه، مقاصد گردشگری محبوب",
  themeColor: "#28A745",
