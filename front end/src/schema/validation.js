...
const personal = yup.object({
  ...
  birthDate: yup.string().default("").required("تاریخ تولد الزامی است!"),
});
const bank = yup.object({
  shaba_code: yup.string().default("").required("شماره شبا الزامی است!"),
  debitCard_code: yup
    .string()
    .default("")
      ...
      return yup.object().shape({
        bank: yup.object().shape({
          shaba_code: yup
            .string()
            .required("شماره شبا الزامی است")
            .matches(/^IR\d+$/, "شماره شبا نا معتبر است"),
          debitCard_code: yup
            .string()
            .required("شماره کارت الزامی است")
